...
| Raw Dataset | Original sales_data dataset file | [`data/raw /sales_data_sample.csv`] |
| Query Screenshots | Selected screenshots of query results from MySOL Workbench | Visual / visuals/sales 1, 2, 3, 4.JPG |
